...
public class TokenRepository {
    ...
    public List<Token> selectTokensSortedByPopularity (int limit, int offset, double maxPrice) {
        String sqlString = "SELECT t.id, t.asset_path, t.created_date, t.creator_id, t.description, t.preview_url, t.title, t.collection_id, t.quantity, t.source_url, " +
        ...
        "GROUP BY t.id, t.asset_path, t.created_date, t.creator_id, t.description, t.preview_url, t.title, t.collection_id, t.quantity, t.source_url, token_price " +
    ...
    public List<Token> selectTokensSortedByLikes (int limit, int offset, double maxPrice) {
        ...
        "GROUP BY t.id, t.asset_path, t.created_date, t.creator_id, t.description, t.preview_url, t.title, t.collection_id, t.quantity, t.source_url, price "+
